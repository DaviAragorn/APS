...
public enum Profile {
	User(Allowence.addObject, Allowence.deleteObject, Allowence.findObject, Allowence.modifyObject,
			Allowence.sendMesseges), Transporter(Allowence.reciveObjects, Allowence.sendMesseges);
